...
#Faz a importação do SVM
from sklearn.svm import SVC
#Faz o aprendizado. 
#kernel = 'rbf' geralmente é o que da o melhor resultado 
#Quando maior o C , maior é onivel de acerto, pois ele procura o melhor vetor
classificador = SVC(kernel = 'rbf', random_state =1, C=100)
