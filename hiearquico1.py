...
#Cria os dados de x e y,com o valor da idade e renda
x=[20,  27,  21,  37,  46, 53, 55,  47,  52,  32,  39,  41,  39,  48,  48]  
y=[1000,1200,2900,1850,900,950,2000,2100,3000,5900,4100,5100,7000,5000,6500]
#Printa o grafico (x,y)
plt.scatter(x,y)

#Cria a base de dados com os valores de x,y relacionados
...
#Pelo dendograma o numero de clusters é 3
hc = AgglomerativeClustering(n_clusters = 3, affinity = 'euclidean', linkage = 'ward')
#Faz o treinamento da vase
previsoes = hc.fit_predict(base)


#Printa o grafico com a base original com seus respectivos clusters finais
