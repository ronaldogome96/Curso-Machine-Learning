...
#Mostra a quantidade de acerto de cada uma das aprendizagens
...
#Faz um novo registro para ser feita a verificação
novo_registro = [[50000, 40, 5000]]
#Mua de tipo lista para tipo float
novo_registro = np.asarray(novo_registro)
#Muda o formato da matriz
novo_registro = novo_registro.reshape(-1, 1)
#Faz o escalonamento
novo_registro = scaler.fit_transform(novo_registro)
#Muda novamente o formato da matriz
novo_registro = novo_registro.reshape(-1, 3)

#MOSTRA O POSSIVEL RESULTADO EM CADA APRENDIZAGEM
